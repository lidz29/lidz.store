          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Temukan koleksi lengkap produk digital berkualitas tinggi untuk
                mengembangkan bisnis dan kreativitas Anda. Dari e-book,
                template, hingga tools digital professional.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <p className="text-gray-600">
                Akses langsung ke produk digital Anda setelah pembelian berhasil
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600">
                Transaksi yang aman dan terpercaya dengan berbagai metode
                pembayaran
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Pilihan terbaik produk digital yang paling diminati oleh pelanggan
              kami
            </p>
          </div>
